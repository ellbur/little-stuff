...
module FromIO
  ...
  data DeferredEvent where
    ...
    ordering : ∀ {A B} → DeferredEvent A → DeferredEvent B
        → DeferredEvent ((A × Event B) ⊎ (B × Event A))
  ...
  transform-with-input i (ordering ev₁ ev₂) with (transform-with-input i ev₁) | (transform-with-input i ev₂)
  ...                                           | (have-it x) | ev₂'        = have-it (inj₁ (x , ev₂'))
  ...                                           | ev₁'        | (have-it y) = have-it (inj₂ (y , ev₁'))
  ...                                           | (waiting-on-input ev₁') | (waiting-on-input ev₂') =
